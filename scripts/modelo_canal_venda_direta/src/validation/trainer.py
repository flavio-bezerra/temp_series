...
class ModelTrainer:
        ...
        for model_name, model in self.models.items():
            ...
            try:
                with run_context:
                    ...
                    full_model_name = f"{self.config.CATALOG}.{self.config.SCHEMA}.venda_direta_{model_name}"
    ...
    def _save_to_delta(self, pdf: pd.DataFrame) -> None:
        ...
        """
        table_name = f"{self.config.CATALOG}.{self.config.SCHEMA}.resultado_metricas_treinamento_venda_direta"
        try:
