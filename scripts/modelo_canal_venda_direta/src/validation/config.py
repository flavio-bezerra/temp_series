...
class Config:
    ...
    def __init__(self, spark_session: Optional[SparkSession] = None):
        ...
        self.VOLUME_ROOT: str = f"/Volumes/{self.CATALOG}/{self.SCHEMA}/experiments/artefacts/venda_direta"
        self.PATH_SCALERS: str = f"{self.VOLUME_ROOT}/scalar/validation"
        self.PATH_MODELS: str = f"{self.VOLUME_ROOT}/models/validation"
        
        # --- CONFIGURAÇÃO MLFLOW ---
        self.EXPERIMENT_NAME: str = "/Workspace/Shared/data_science/projetos/cvc_curva_de_vendas_por_canal/experiments/Model_Validation_CVC_Venda_Direta"
