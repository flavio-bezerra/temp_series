...
class Config:
    ...
    def __init__(self, spark_session: Optional[SparkSession] = None):
        ...
        self.EXPERIMENT_NAME: str = f"/Workspace/Shared/data_science/projetos/cvc_curva_de_vendas_por_canal/experiments/Model_Validation_CVC_{'_'.join(w.capitalize() for w in _CANAL.split('_'))}"
